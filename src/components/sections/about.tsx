  ...
  return (
    ...
    >
      <div className="container-x">
        {/* Section heading — matches MVN: large, two lines max */}
        <Reveal>
        ...
        <div className="mt-20 grid grid-cols-1 gap-8 lg:grid-cols-12 lg:gap-10">
          {/* Left — image card */}
          <Reveal className="lg:col-span-7">
            <div className="relative aspect-[5/4] overflow-hidden rounded-4xl bg-ink-900">
              <Image
                src="https://images.fillout.com/orgid-720100/flowpublicid-hmhysps8op/widgetid-default/uAXs1yKTVJwB2B4wSbNcGs/pasted-image-1780762902432-a5cjxe2q.png"
                alt="Tapping Frenzy on Roblox"
                fill
          ...
          <div className="lg:col-span-5">
            ...
            <RevealStagger className="mt-10 grid grid-cols-2 gap-3">
              <RevealItem>
                <PillStat value="+29" label="Live CCU" sub="across portfolio" />
              </RevealItem>
              <RevealItem>
                <PillStat value="56K" label="Visits" sub="lifetime" />
              </RevealItem>
              <RevealItem>
                <PillStat value="413" label="Favorites" sub="from players" />
              </RevealItem>
              <RevealItem>
                <PillStat value="2" label="Studios" sub="in network" />
              </RevealItem>
            </RevealStagger>
          </div>
        </div>
